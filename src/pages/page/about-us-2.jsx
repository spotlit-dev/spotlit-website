            ...
            <div className="ps-block--about-2">
              ...
              <div className="ps-block__content">
                ...
                <p>
                  ...
                  Commodi corporis ea sunt voluptatum? Assumenda atque commodi
                  consectetur cum cumque, dolore doloremque eaque ipsam magni
                  optio sit voluptatum! Libero, optio totam!
                </p>
                <p>
                  {' '}
                  On refusa continuar payar custosi traductores. At solmen va
                  esser necessi far uniform grammatica, pronunciation e plu
                  sommun paroles. Ma quande lingues coalesce, li grammatica del
                  resultant lingue es plu simplic e regulari quam ti del
                  coalescent lingues.{' '}
                </p>
              </div>
